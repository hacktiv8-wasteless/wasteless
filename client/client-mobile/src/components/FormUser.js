      ...
      {page === "Register" && (
        <Center w="100%">
          <Box safeArea p="2" py="8" w="90%" maxW="290">
            <Heading>Welcome</Heading>
            <Heading>Sign in to continue!</Heading>
            <Input type="text" placeholder="username" onChangeText={handleUsernameChange} />
            <Input type="email" placeholder="email" onChangeText={handleEmailChange} />
            <Input
            ...
            />
            <Input type="phoneNumber" placeholder="text" onChangeText={handlePhoneNumberChange} />
            <Input type="address" placeholder="text" onChangeText={handleAddressChange} />
